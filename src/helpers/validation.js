...
exports.validationRegister = async(data) => {
    ...
    if (!data.phone || data.phone === '') {
        result = {...result, phone: 'phone must be filled.' }
    }
...
exports.validationUser = async(data) => {
    ...
    if (!data.display_name || data.display_name === '') {
        result = {...result, display_name: 'Display name must be filled.' }
    }

    if (!data.first_name || data.first_name === '') {
        result = {...result, first_name: 'Firstname must be filled.' }
    }

    if (!data.last_name || data.last_name === '') {
        result = {...result, last_name: 'Lastname must be filled.' }
    }
    if (!data.gender || data.gender === '') {
        result = {...result, gender: 'Gender must be filled.' }
    }
    if (!data.birthdate || data.birthdate === '') {
        result = {...result, birthdate: 'Birthdate must be filled.' }
    }
    return result
}
