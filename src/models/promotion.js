...
exports.getDataPromotions = (data) =>
  new Promise((resolve, reject) => {
    ...
    const query = db.query(
      `SELECT pr.name,pr.code,concat('${APP_URL}/',image) AS image,pr.description,pr.normal_price ,pr.discount_value, pr.available_start_at, pr.available_end_at
...
exports.countDataPromotions = (data) =>
  new Promise((resolve, reject) => {
    const filled = ['discount_value', 'delivery_method_id'];
    let resultFillter = '';
    filled.forEach((item) => {
...
exports.insertDataPromotion = (data) =>
  new Promise((resolve, reject) => {
...
exports.updateDataPromotion = (data, id) =>
  new Promise((resolve, reject) => {
...
exports.deleteDataPromotion = (id) =>
  new Promise((resolve, reject) => {
